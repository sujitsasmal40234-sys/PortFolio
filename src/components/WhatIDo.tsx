        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4 style={{fontSize: "2rem"}}>Visual Storytelling & Branding</h4>
              <p>
                Crafting visually stunning designs for digital and print media.
                From poster design to complete brand identities, I deliver impactful concepts.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4 style={{fontSize: "2rem"}}>Dynamic Visual Experiences</h4>
              <p>
                Bringing designs to life through animation and visual effects.
                Creating engaging video content and multimedia for various platforms.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
